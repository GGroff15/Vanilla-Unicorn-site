...
class ArquivoCSVTest {

	@Test
	void testGerar() throws ExtensaoInvalidaException {
		...
		arquivo = ArquivoServiceFactory.create(datas.getDataInicial(), datas.getDataFinal(), "csv");
		...
		arquivo.gerar(consumoVOs, 0);

		assertNotEquals(null, arquivo.getBytes());
		assertEquals("relatorio_consumo_perido_10/12/2021_30/12/2021.csv", arquivo.getNomeArquivo());
	}
